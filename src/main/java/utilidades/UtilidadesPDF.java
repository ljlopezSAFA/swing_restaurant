...
public class UtilidadesPDF {
    ...
    public static void GenerarCuentaPDF(Cuenta cuenta){
        ...
        try {
            ...
            // Image
            PDImageXObject pdImage = PDImageXObject.createFromFile(new File("").getAbsolutePath() +"\\imagenes\\logo_restaurante.jpg", document);
